...
The license is easy to pass into the container deployment either as a file or an environment variable. Licensing does not require network access and works in offline deployments.
